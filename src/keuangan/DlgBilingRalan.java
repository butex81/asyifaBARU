...
public class DlgBilingRalan extends javax.swing.JDialog {
    ...
    private ResultSet rscekbilling,rscarirm,rscaripasien,rsreg,rscaripoli,rscarialamat,rsrekening,rsobatoperasi,
            ...
            rsakunbayar,rsakunpiutang,rscaripoli2,rskasdebit;
    ...
    private void initComponents() {
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-07-2018 13:05:09" }));
            ...
            if(TNoRw.getText().trim().equals("")||TNoRM.getText().trim().equals("")||TPasien.getText().trim().equals("")){
                ...
                try{
                    ...
                    if(piutang<=0){                        
                        ...
                        Sequel.menyimpan("temporary_bayar_ralan","'0','CASH DARI PASIEN',':','','','','','"+Valid.SetAngka(bayar)+"','Tagihan','"+var.getkode()+"','','','','','','','',''","Tagihan"); 
                        pskasdebit = koneksi.prepareStatement(
                                "select no_rawat, nama_bayar, besar_bayar from detail_nota_jalan "+
                                        "where no_rawat=? order by nama_bayar");
                        try{
